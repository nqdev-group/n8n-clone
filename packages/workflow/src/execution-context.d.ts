...
declare const CredentialContextSchemaV1: any;
export type ICredentialContextV1 = z.output<typeof CredentialContextSchemaV1>;
export declare const CredentialContextSchema: any;
/**
...
export declare const safeParse: <T extends ZodType>(value: string | object, schema: T) => any;
/**
